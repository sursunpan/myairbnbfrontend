...
const Reservation: React.FC<ReservationSidebarProps> = ({
  property,
  userId,
}) => {
  ...
  return (
    <aside className="mt-6 p-6 col-span-2 rounded-xl border-gray-300 shadow-xl">
      ...
      <div
        ...
        className="w-full mb-6 py-6 text-center text-white bg-airbnb hover:bg-airbnbDark rounded-xl cursor-pointer"
      >
        Book
      </div>
